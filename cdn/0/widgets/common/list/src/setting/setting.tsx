...
> {
  ...
  displaySelectedFields = values => {
    return this.formatMessage('searchSelected', {
          ...
          <SettingRow label={this.formatMessage('hover')}>
            ...
            >
              ...
              <Icon
                ...
                style={{ flex: 'none' }}
                size={12}
                icon={require('jimu-ui/lib/icons/arrow-right-12.svg')}
              />
            </div>
          </SettingRow>
            ...
            label={
              ...
              >
                <Icon
                  autoFlip
                  size={14}
                  icon={require('jimu-ui/lib/icons/arrow-left-14.svg')}
                />
  ...
  render () {
    ...
    return (
      <div
        className={classNames(`${prefix}list-setting`, `${prefix}setting`, 'position-relative')}
