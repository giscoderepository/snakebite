...
import { SettingSection, SettingRow, LinkParam, LinkSettingPopup } from 'jimu-ui/advanced/setting-components'
          ...
          <SettingSection>
            ...
            {this.props.useDataSourcesEnabled && <div className='mt-3'>
              <Tabs fill pills onTabSelect={this.onTabSelect}>
                <Tab
                  id='staticSource' active={!this.props.config.functionConfig.imgSourceType ||
                ...
                <Tab
                  id='dynamicSource' active={(this.props.config.functionConfig.imgSourceType === ImgSourceType.ByDynamicUrl)}
