...
> {
  ...
  constructor (props) {
    ...
    if (!config.isInitialed) {
      appConfig = getAppConfigAction().editWidget(appConfig.widgets[id])
        .appConfig
  ...
  editLayoutItemSize = (appConfigAction, style: ItemStyle) => {
    ...
    if (layoutType === LayoutType.FixedLayout) {
      appConfigAction
        .editLayoutItemSize(layoutInfo, cardSize.width, cardSize.height)
        .exec()
    }
  }
  ...
  checkIsStatButtonPosition = () => {
    ...
    const templateConParentHeight =
      this.templatesContain?.current?.parentNode?.clientHeight || 0
  ...
  renderSetLinkSetting = () => {
    ...
    return (
      this.state.isLinkSettingShown &&
      !urlUtils.getAppIdPageIdFromUrl().pageId && (
        <LinkSettingPopup
          showDialog={this.state.isLinkSettingShown}
          onSettingCancel={() => {
        ...
        title={
          <div className='w-100 d-flex justify-content-between'>
            ...
            <Button
              ...
              type='tertiary'
              icon
              onClick={this.handleShowRegularClick}
            >
              <Icon
                size={12}
                color={theme.colors.black}
                icon={showRegular ? arrowUp : arrowDown}
              />
            </Button>
          </div>
        }
        ...
        title={
          <div className='w-100 d-flex justify-content-between'>
            ...
            <Button
              ...
              type='tertiary'
              icon
              onClick={this.handleShowHoverClick}
            >
              <Icon
                size={12}
                color={theme.colors.black}
                icon={showHover ? arrowUp : arrowDown}
              />
            </Button>
          </div>
        }
