...
const statesModifiers = [
  {
    ...
    options: {
      ...
      fallbackPlacements: ['right-start', 'left-start', 'bottom-start' ]
    }
  }
]
        ...
        >
          ...
          {cardConfigs[Status.Selected].selectionMode !==
            ...
            <BuilderButton
                ...
                className='mt-1'
                onClick={evt =>
                this.handleBuilderStatusChange(evt, Status.Selected)}
              >
          ...
          {!isSelf && (showSync || showBreak) && (
            <BuilderDropDown
              ...
              direction='left'
              toggleContent={theme => (
                <Icon icon={showBreak ? toolSync : toolIsolate} size={16} />
              )}
